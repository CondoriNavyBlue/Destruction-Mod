...
const DestructionJunction = extend(Junction, "Destruction_Junction", {
    localizedName: "Destruction Junction",
    category: Category.distribution,
    requirements: ItemStack.with(items.iron,2 , items.gold,2 , items.diamond,2),
    buildVisibility: BuildVisibility.shown,
    speed: 24,
    capacity: 12,
    health: 850,
...
//Destruction Bridge
const DestructionBridge = extend(ItemBridge, "Destruction_Bridge", {
    localizedName: "Destruction Bridge",
    requirements: ItemStack.with(items.iron,5 , items.gold,5 , items.diamond,1),
    buildVisibility: BuildVisibility.shown,
    category: Category.distribution,
    fadeIn: false,
    moveArrows: false,
...
const DestructionPhaseBridge = extend(ItemBridge, "Destruction_Phase_Bridge", {
    localizedName: "Destruction Phase Bridge",
    requirements: ItemStack.with(Items.phaseFabric,25 , Items.silicon,35 , Items.graphite,25 , items.diamond,10),
    buildVisibility: BuildVisibility.shown,
    category: Category.distribution,
    range: 31,
    arrowPeriod: 0.9,
...
//Destruction Node
const DestructionNode = extend(PowerNode, "Destruction_Node", {
    localizedName: "Destruction Node",
    maxNodes: 20,
    laserRange: 12,
    underBullets: true,
    crushFragile: true,
...
const DestructionLargeNode = extend(PowerNode, "Destruction_Large_Node", {
    localizedName: "Destruction Large Node",
    size: 2,
    maxNodes: 40,
    laserRange: 32,
    health: 720,
...
const DestructionDiamondNode = extend(PowerNode, "Destruction_Diamond_Node", {
    localizedName: "Destruction Diamond Node",
    size: 2,
    maxNodes: 4,
    laserRange: 75,
    health: 1000,
    ...
    Items.copper, extend(BasicBulletType, 3, 22.5, {
        ...
        hitEntity(b, entity, health){
            ...
            if(entity instanceof Unit){
                entity.health -= (typeof b.splashDamage === "number" ? Math.max(b.splashDamage, b.damage) : b.damage)/4;
            }
...
//Mend Destruction
const MendDestruction = extend(MendProjector, "Mend_Destruction", {
    localizedName: "Mend Destruction",
    requirements: ItemStack.with(Items.lead,380 , Items.titanium,325 , Items.silicon,400 , Items.surgeAlloy,120 , items.sodiumBattery,500),
    category: Category.effect,
    buildVisibility: BuildVisibility.shown,
    size: 3,
    reload: 300,
...
//Overdrive Diamond
const OverdriveDiamond = extend(OverdriveProjector, "Overdrive_Diamond", {
    localizedName: "Overdrive Diamond",
    requirements: ItemStack.with(Items.lead,10000 , Items.titanium,10000 , Items.silicon,10000 , Items.plastanium,10000, Items.phaseFabric,10000 , Items.surgeAlloy,10000 , items.sodiumBattery,10000 , items.diamond,3000),
    category: Category.effect,
    buildVisibility: BuildVisibility.shown,
    useTime: 300,
    itemCapacity: 100,
...
module.exports = {
    ...
    DestructionJunction: DestructionJunction,
    DestructionBridge: DestructionBridge,
    DestructionPhaseBridge: DestructionPhaseBridge,
    ...
    ForceDestruction: ForceDestruction,
    MendDestruction: MendDestruction,
    OverdriveDiamond: OverdriveDiamond
};